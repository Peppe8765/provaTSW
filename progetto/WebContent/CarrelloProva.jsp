...
<%}%>
		...
		<form action="<%=response.encodeURL("CartControl")%>" method="GET">
			...
			<label class="label" for="Destonatario">Destinatario:</label><br>
			<input class="rettangoli" type="text" id="Destinatario" name="Destonatario" placeholder="Nome Cognome" maxlength="50" required><br>
			<label class="label" for="Telefono">Telefono:</label><br>
			<input class="rettangoli" type="text" id="Telefono" name="Telefono" placeholder="000 0000000" min="0000000000" maxlength="10" required><br>
