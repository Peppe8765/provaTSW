...
if(messageUser != null && !messageUser.equals("")) {
%>
	<p style="color: green;"><%=messageUser %></p>
<%} %>
	</div>
	...
	<div id="AddEvent" class="tabcontent">
		<form action="">
			...
			<input class="rettangoli" type="radio" onclick="concerto()" id="RadioConcerto" name="Radiobutton" >
			<label for="Radiobutton">Concerto</label><br>
			<input class="rettangoli" type="radio" onclick="eventoSportivo()" id="RadioEventoSportivo" name="Radiobutton" >
