...
insert into Stadio(Nome, Nazione, Città, Indirizzo , Capienza, Descrizione, Comune_CCodiceID, Società_SCodiceID)
values("Camp Nou", "Spagna", "Barcellona", "Avinguda de Joan XIII", 99354, "Il Camp Nou è un impianto calcistico spagnolo ubicato nel quartiere Les Corts della città di Barcellona.
